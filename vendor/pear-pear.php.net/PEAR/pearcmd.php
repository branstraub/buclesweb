...
if ('C:\Users\Ramiro\Desktop\Diseños\bucles design\web\buclesweb\vendor/pear-pear.php.net/PEAR ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\Ramiro\Desktop\Diseños\bucles design\web\buclesweb\vendor/pear-pear.php.net/PEAR '));
    $raw = false;
} else {
